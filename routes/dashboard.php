...
// TODO: Make a middleware to remove any key with empty values from request
...
//                event(new \App\Events\NewMessageEvent("My MSG"));
                $msg = \App\Models\Message::first();
                event(new \App\Events\NewMessageEvent($msg));
//                broadcast(new \App\Events\NewMessageEvent($msg))->toOthers();
