...
return [
   ...
   |--------------------------------------------------------------------------
   |
   | This value is the default currency of your application. Only 3 characters.
   |
   */
...
//        'MyCard' => App\Providers\CartServiceProvider::class,
        ...
        'CategoryStatus' => App\Enums\CategoryStatus::class,
        'OrderAddressTypes' => App\Enums\OrderAddressTypes::class,
    ])->toArray(),
