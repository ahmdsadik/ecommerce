                        ...
                        <form class="row" action="{{ route('register') }}" method="post">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="name" type="text" value="{{ old('name') }}" id="reg-fn" required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="email" type="email" value="{{ old('email') }}" id="reg-email" required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="phone" type="text" value="{{ old('phone') }}" id="reg-phone">
