                ...
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="single-block give-review">
                            <h4>{{ round($product->reviews_avg_rate,1) }} (Overall)</h4>
                            <ul>
                                @for($i=5; $i > 0 ; $i--)
                                    <li>
                                        <span>{{ $i }} stars - {{ $revCount->get($i) ?? 0 }}</span>
                                        @for($a= 1; $a <= $i ; $a++)
    ...
    <div class="modal fade review-modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('front.review.product.store', $product) }}" method="post">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" class="form-control" id="review-message" rows="8"
                                      required></textarea>
                        </div>
                    </div>
