...
@section('title')
    {{ __('dashboard/category/create.title') }}
@endsection
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <a class="text-muted fw-light"
               href="{{ route('dashboard.categories.index') }}">{{ __('dashboard/category/create.breadcrumb_1') }}</a>
            /
            {{ __('dashboard/category/create.breadcrumb_2') }}
        </h4>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    <h5 class="card-header">{{ __('dashboard/category/create.card_header') }}</h5>
                        ...
                        <form action="{{ route('dashboard.categories.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <label for="name"
                                                           class="form-label">{{ __('dashboard/category/create.name',['lang' => __('lang_key.with_'.$key)]) }}</label>
                                                    <input class="form-control" type="text" id="name" name="{{$key}}[name]"
                                                           placeholder="{{ __('dashboard/category/create.name_placeholder',['lang' => __('lang_key.with_'.$key)]) }}"
                                                           value="{{ old($key.'.name') }}"/>
                                                ...
                                                <div class="col-md-6">
                                                    <label for="description"
                                                           class="form-label">{{ __('dashboard/category/create.description',['lang' => __('lang_key.with_'.$key)]) }}</label>
                            ...
                            <div class="col-md-6 ">
                                <label for="select2Dark"
                                       class="form-label">{{ __('dashboard/category/create.category') }}</label>
                                <div class="select2-dark">
                                    <select id="select2Dark" class="select2 form-select" name="parent_id">
                                        <option value>{{ __('dashboard/category/create.no_category') }}</option>
                            ...
                            <div class="card-footer mt-3">
                                <button class="btn btn-primary w-100"
                                        title="{{ __('dashboard/category/create.submit_btn') }}">{{ __('dashboard/category/create.submit_btn') }}</button>
                            </div>
